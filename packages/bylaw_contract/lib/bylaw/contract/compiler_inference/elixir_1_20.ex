defmodule Bylaw.Contract.CompilerInference.Elixir120 do
  ...
  if Version.match?(System.version(), "~> 1.20") do
    ...
    @doc false
    @spec return_alternatives(module :: module(), exports :: list()) :: {:error, String.t()}
    def return_alternatives(_module, _exports),
      do: {:error, "compiler inference requires Elixir 1.20 or newer"}
  end
end
