defmodule Bylaw.Ecto.Query.Checks.NamedBindingsTest do
  ...
  describe "validate/3" do
    ...
    test "ignores rootless predicates generated by Ecto repo reloads" do
      post = struct(Post, %{id: 1})

      {operation, query, _opts} =
        capture_prepare_query(fn ->
          Queryable.reload(CaptureRepo, post, repo_tuplet())
        end)
    ...
    test "ignores rootless predicates generated by Ecto repo reload bangs" do
      post = struct(Post, %{id: 1})
